...
## Marti & Liz
Before getting started, make sure your issue has not been discussed earlier. You can search for existing tickets [here](https://github.com/Slushman/_s/search).
...
* We decided to not include translations [[#50](https://github.com/Slushman/_s/pull/50)] beyond the exisiting `_s.pot` file, a RTL stylesheet [[#263](https://github.com/Slushman/_s/pull/263)], or editor styles [[#225](https://github.com/Slushman/_s/pull/225)], as they are likely to change during development of an `_s`-based theme.
...
## Underscores.me
If your issue is specific to the [Underscores.me](http://underscores.me) website, the [Underscores.me GitHub repo](https://github.com/Slushman/underscores.me) is the right place for you.
